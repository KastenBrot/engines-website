...
import { AssettoBackground, AssettoScreenshot, CS2Background, CS2Screenshot, Discord, F1Background, F1Screenshot, LolBackground, LolScreenshot, OWBackground, OWScreenshot, RLBackground, RLScreenshot, RainbowBackground, RainbowScreenshot, ValorantBackground, ValorantScreenshot  } from "@/public";
...
const content = [
  ...
  },
  {
    id: 'assetto',
    title: 'ASSETTO CORSA',
    description: '"Assetto Corsa" ist ein realistisches Rennspiel, das sich auf authentisches Fahrverhalten und präzise Simulation konzentriert. Spieler können eine Vielzahl von Autos auf originalgetreuen Rennstrecken fahren. Das Spiel bietet verschiedene Modi, darunter Einzelrennen, Karrieremodus und Online-Wettbewerbe gegen andere Spieler. Es erfordert präzises Fahren, gute Fahrzeugbeherrschung und Anpassung an verschiedene Streckenbedingungen. "Assetto Corsa" ist bekannt für seine detaillierte Physik-Engine und umfangreiche Anpassungsmöglichkeiten für Fahrzeuge.',
